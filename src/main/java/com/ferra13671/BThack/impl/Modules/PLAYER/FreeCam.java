...
import com.ferra13671.BThack.Events.Events.*;
...
import com.ferra13671.BThack.Events.Events.Player.ChangePlayerLookEvent;
...
public class FreeCam extends Module {
    ...
    public void onEnable() {
        ...
        fakePlayer = PlayerUtils.createNewFakePlayer(mc.player, mc.player.getDisplayName().getString());
    }
