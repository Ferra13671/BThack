...
public class TopperRadar extends Module {
    ...
    public TopperRadar() {
        ...
        threshold = new NumberSetting("Min match threshold", this, 3, 1, 4, true);
        amount = new NumberSetting("Min amount of armor", this, 3, 1, 4, true);
    ...
    public void onClientTick(TickEvent.ClientTickEvent e) {
        ...
        for (PlayerEntity player : mc.world.getPlayers()) {
            ...
            Iterable<ItemStack> equipmentArmor = player.getArmorItems();
            ...
            for (ItemStack itemStack : equipmentArmor) {
                ...
                if (itemStack.getItem() instanceof ArmorItem armor) {
                    ...
                    for (NbtElement enchantment : itemStack.getEnchantments()) {
                        ChatUtils.sendMessage(enchantment.toString());
