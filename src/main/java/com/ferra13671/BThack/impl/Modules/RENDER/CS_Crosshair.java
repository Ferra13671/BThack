...
public class CS_Crosshair extends Module {
    ...
    @EventSubscriber
    public void onHudElement(RenderHudElementEvent e) {
        if (e.elementType == RenderHudElementEvent.ElementType.CROSSHAIRS)
            e.setCancelled(true);
    }
    ...
    public void onOverlay(RenderHudPostEvent e) {
        ...
        Color color = rainbow.getValue() ? new Color(ColourUtils.rainbow(100)) : new Color((int) redColor.getValue(), (int) greenColor.getValue(), (int) blueColor.getValue());
