...
public class TaskButton extends Button {
    ...
    public void renderButton() {
        ...
        if (selected) {
            BThackRender.drawOutlineRect((int) (this.getCenterX() - (stringWidth * 1.2) - 1), (int) (this.getCenterY() - (heightFactor / 2) - 1), (int) (this.getCenterX() + (stringWidth * 1.2) + 1), (int) (this.getCenterY() + (heightFactor / 2) + 1), 1, ColourUtils.rainbow(100));
        }
