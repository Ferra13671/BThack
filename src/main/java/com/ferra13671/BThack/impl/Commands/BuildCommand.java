...
public class BuildCommand extends AbstractCommand {
    ...
    public void execute(String[] args) {
        ...
        ItemsUtils.useItemOnBlock(new ModifyBlockPos(mc.player.getX() + Double.parseDouble(args[0]), mc.player.getY() + Double.parseDouble(args[1]), mc.player.getZ() + Double.parseDouble(args[2])));
    }
}
