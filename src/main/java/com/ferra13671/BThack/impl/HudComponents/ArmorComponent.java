        ...
        for (int i = 3; i > -1; i--) {
            ...
            if (armorStack.getItem() != Items.AIR) {
                ...
                if (ItemUtils.getItemDurabilityInPercentages(armorStack) > 0)
                    BThackRender.drawRect((int) getX() + 20, (int) (getY() + y + mc.textRenderer.fontHeight), (int) (getX() + 20 + (50 * (ItemUtils.getItemDurabilityInPercentages(armorStack) / 100f))), (int) (getY() + y + mc.textRenderer.fontHeight + 3), new Color(armorStack.getItemBarColor()).hashCode());
            }
