...
public final class BThackRender implements Mc {
    ...
    public static void drawRect(float x1, float y1, float x2, float y2, int color) {
        drawRect(x1, y1, x2, y2, color, pose.peek().getPositionMatrix());
    }
    ...
    public static void drawHorizontalRainbowRect(float x1, float y1, float x2, float y2, int rainbowType) {
        ...
        while (tX != x2) {
            ...
            vertexconsumer.vertex(matrix4f, tX, y1, (float)0).color(f, f1, f2, f3).next();
            vertexconsumer.vertex(matrix4f, tX, y2, (float)0).color(f, f1, f2, f3).next();
            vertexconsumer.vertex(matrix4f, tX + dX, y2, (float)0).color(f, f1, f2, f3).next();
            vertexconsumer.vertex(matrix4f, tX + dX, y1, (float)0).color(f, f1, f2, f3).next();
            guiGraphics.draw();
